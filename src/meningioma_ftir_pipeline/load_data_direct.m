%% DIRECT DATA LOADING - NO INTERMEDIATE FILES
% Simplified data loading that works directly with the original data tables
%
% Key improvements:
% - Works directly with dataTableTrain/dataTableTest (no intermediate files)
% - Properly handles Patient_ID (for stratification) vs Diss_ID (for samples)
% - Keeps all spectra in original CombinedSpectra format
% - Minimal data restructuring
